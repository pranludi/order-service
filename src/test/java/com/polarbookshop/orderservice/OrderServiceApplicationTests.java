...
class OrderServiceApplicationTests {
    ...
    @Container
    static RabbitMQContainer rabbitMQ = new RabbitMQContainer(DockerImageName.parse("rabbitmq:4.1"));
    ...
    static void postgresqlProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("spring.rabbitmq.port", rabbitMQ::getPortBindings);
        registry.add("spring.rabbitmq.username", rabbitMQ::getAdminUsername);
        registry.add("spring.rabbitmq.password", rabbitMQ::getAdminUsername);
